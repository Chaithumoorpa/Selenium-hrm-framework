...
class LeaveLocators:
    ...
    COMMENT_TEXTAREA = (By.XPATH, "//label[text()='Comments']/following::textarea[1]")
    ...
    STATUS_DROPDOWN = (By.XPATH, "//label[text()='Show Leave with Status']/following::div[contains(@class,'oxd-select-text')][1]")
